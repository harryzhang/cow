...
import com.redpack.common.account.IUserAccountDetailService;
...
import com.redpack.dao.withdraw.IWithdrawDao;

@Service("cowBizUserAccountService")
public class CowBizUserAccountServiceImpl implements ICowBizUserAccountService, IFeiHongService {
	private static final Logger LOGGER = Logger.getLogger(CowBizUserAccountServiceImpl.class);
	@Autowired
