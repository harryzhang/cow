...
@Service("cowUserAccountService")
public class CowUserAccountServiceImpl implements IBizUserAccountService, IFeiHongService {
	private static final Logger LOGGER = Logger.getLogger(CowUserAccountServiceImpl.class);
	@Autowired
