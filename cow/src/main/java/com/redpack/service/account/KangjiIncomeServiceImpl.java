...
import com.redpack.common.account.model.KangjiIncomeDo;
...
import com.redpack.dao.account.IKangjiIncomeDao;
...
public class KangjiIncomeServiceImpl implements IKangjiIncomeService {
	...
	public void doJob() {
		...
		String date = com.redpack.common.util.DateUtil.formatDate(today);
