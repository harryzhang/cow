...
import com.redpack.common.account.IUserServiceCache;
...
import com.redpack.dao.group.IGroupDao;
import com.redpack.dao.group.IGroupIndexManagerDao;
...
public class UserServiceCacheImpl implements IUserServiceCache {
	
	private static Map<Long,UserDo> userCachMap = new HashMap<Long,UserDo>();
	
	private static final Logger logger = Logger.getLogger(UserServiceCacheImpl.class);
...
//    private IUserAccountIncomeDao  userAccountIncomeDao;
	...
	public UserDo getById(Long id) {
		...
		UserDo userDo = userCachMap.get(id);
		if(null == userDo){
			userDo= userDao.getById(id);
			userCachMap.put(id, userDo);
		}
		return userDo;
	}
	...
	private static long[][] getParentIds(){
     ...
     public  static void main(String[] args){
    	 ...
    	 UserServiceCacheImpl userServiceImpl = new UserServiceCacheImpl();
