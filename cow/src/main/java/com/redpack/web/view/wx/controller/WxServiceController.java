package com.redpack.web.view.wx.controller;
...
import com.redpack.common.account.model.WeiXinOauth2TokenDo;
...
public class WxServiceController {
	...
	private static final Logger logger = Logger.getLogger(WxServiceController.class);
