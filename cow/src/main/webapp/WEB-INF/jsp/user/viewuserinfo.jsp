        ...
        <div class="main">
            <form action="" class="form_wrap">
            	<div class="formStyle1">
	                 ...
	                 <div class="form_box form_line reg_recom clearfix">
	                    <span class="fl">真实姓名：</span>
	                   
	                    <div >
	                        <input type="text"  class="push_phone_input" placeholder="真实姓名"  id="name" value="${userDo.name}">
	                    </div>
	                </div>
	                ...
	                <div class="form_box clearfix reg_recom">
	                    ...
	                    <div >
	                        <input type="text"  class="push_phone_input" placeholder="微信账号"  autocomplete="off" value="${userDo.weixin}" id="weixin">
	                    </div>
	                </div>					
	              </div>
	                ...
	                -->
	                <a href="javascript:history.go(-1);" class="btn funcBtn btn_green login_btn" >返回</a>
            </form>
        </div>
    </div>
